    ...
    <li className="card bg-gray-100 flex flex-row justify-between items-center border border-gray-300 p-4">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4">
            <div className="w-32 text-base font-semibold flex flex-1 justify-between items-center text-center border border-gray-300 rounded-full overflow-hidden select-none">
              <span
